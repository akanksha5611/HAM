...
.row::after {
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">HAM</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
			  ...
			  <li class="nav-item"><a href="#resume-section" class="nav-link"><span>Work</span></a></li>
	      ...
	      <div class="slider-item ">
	        ...
	        <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(images/bg1.png);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Hello!</span>
			            <h1 class="mb-4 mt-3">We are <span>HAM</span></h1>
			            <h2 class="mb-4">You Think , We Create</h2>
			            <p><a href="#" class="btn btn-primary py-3 px-4">Hire Us</a> <a href="#" class="btn btn-white btn-outline-white py-3 px-4">My works</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
	      ...
	      <div class="slider-item">
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(images/bg2.png);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Hello!</span>
			            <h1 class="mb-4 mt-3">We are <span>Creators</span></h1>
			            <p><a href="#" class="btn btn-primary py-3 px-4">Hire Us</a> <a href="#" class="btn btn-white btn-outline-white py-3 px-4">My works</a></p>
		            </div>
		          </div>
	        	</div>
    	...
    	<div class="container">
    		<div class="row d-flex">
							...
							<div class="row">
								...
								<!-- <div class="overlay">
								 <div class="text">Hello World</div> -->
								  <img src="images/1.jpeg" class="image" alt="Snow" style="width:100%">
								</div>
								<div class="column">
              ...
              <div class="text">
                ...
                <p><a href="#" class="btn btn-primary py-3 px-3">Click</a></p>
              </div>
	          </div>
	        </div>
        </div>
    ...
    <section class="ftco-section ftco-no-pb" id="resume-section">
    	<div class="container">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
          	<h1 class="big big-2">Work</h1>
            <h2 class="mb-4">Work</h2>
            <p>Build your brand and your business through intelligent and attractive web design that works to create a memorable customer experience.</p>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-6">
    				<div class="resume-wrap ftco-animate">
    					...
    					<p class="mt-4">Build your brand and your business through intelligent and attractive web design that works to create a memorable customer experience</p>
    				</div>
    				<div class="resume-wrap ftco-animate">
    					<span class="date">2014-2015</span>
    		...
    		<div class="row justify-content-center mt-5">
    			<div class="col-md-6 text-center ftco-animate">
    				<p><a href="#" class="btn btn-primary py-4 px-5">Click</a></p>
    			</div>
    		</div>
    	</div>
    </section>
